  ...
  <div id="main">
    <div data-include="header">
      <header class="main-header header-down">
        <div
          class="header-top border-0"
          style="position: fixed; width: 100vw; backdrop-filter: blur(10px)"
        >
        ...
        <div class="header-upper">
          <div class="auto-container">
            <div
              class="main-box d-flex justify-content-between align-items-center flex-wrap"
            >
              ...
              <div class="logo-box">
                <div class="logo">
                  <a href="#" title="Delici - Restaurants HTML Template"
                    ><img
                      src="https://tsi.com.vn/assets/images/logo.png"
                      alt=""
              ...
              <div class="link link-btn">
                <a href="#" class="theme-btn btn-style-one clearfix">
                  <span class="btn-wrap">
                    ...
                    ><span class="text-two">Liên hệ</span></span
                  ></a
                >
              </div>
            </div>
    ...
    <section class="banner-section">
      <div class="banner-container">
        <div
          ...
          :style="{
            background: `url(${require('@/assets/ig/7nyKJuX.jpeg')}) center/cover no-repeat`,
          }"
        >
              ...
              <div class="content">
                <div class="inner text-center w-100">
                  ...
                  <h4 class="text">
                    ...
                    <span style="color: #f1d1a9"
                      >tư vấn thành lập pháp nhân và giấy phép, kinh doanh xuất
                      nhập khẩu quốc tế<br /><br
                    /></span>
                  </h4>
                </div>
              </div>
      ...
      <div class="outer-container">
        <div class="row clearfix">
          <div
            ...
            :style="{
              background: `url(${require('@/assets/ig/lvJR7G6.jpeg')}) center/cover no-repeat`,
            }"
          ></div>
              ...
              <div class="content-box">
                <div class="title-box centered">
                  ...
                  <div class="text" style="text-align: left">
                    ...
                    <br /><br /><span class="lead"
                      >TSI tập trung vào việc nâng cao chất lượng sản phẩm thông
                      qua việc kiểm soát chất lượng sản phẩm, quản lý chuỗi cung
                      ứng. Bắt đầu từ việc xây dựng mối liên hệ hợp tác trực
                      tiếp với các nông trại và ngư trường, TSI sẽ trực tiếp đưa
                      sản phẩm tươi nguyên và chất lượng nhất từ khắp nơi trên
                      Thế giới đến người tiêu dùng Việt Nam và các thị trường
                      quốc tế khác.<br /><br />Từ 2023, doanh nghiệp cũng mở
                      rộng dịch vụ tư vấn thành lập doanh nghiệp và giấy phép
                      xuất nhập khẩu quốc tế.</span
                    >
                  </div>
                </div>
              </div>
              ...
              <div class="content-box">
                <div class="title-box centered">
                  ...
                  <div class="text" style="text-align: right">
                    ...
                    <br /><br /><span class="lead"
                      ><span class="lead"
                        >Bào ngư viền xanh Australia (Úc) được mệnh danh là loại
                        bào ngư ngon nhất và đắt đỏ bậc nhất thế giới. Không chỉ
                        bởi sản lượng khan hiếm, giá trị bào ngư còn phản ánh
                        qua quy trình khai thác đảm bảo chất lượng và chất lượng
                        của dòng sản phẩm. Bào ngư trở thành món quà quý giá từ
                        đại dương và được giới thượng lưu săn lùng.&nbsp;<br /></span></span
                    ><span class="lead"><br /><br /></span>
                  </div>
              ...
              <div class="inner-box">
                ...
                <div class="text desc">
                  <span
                    ...
                    data-sheets-userformat='{"2":37633,"3":{"1":0},"11":4,"12":0,"15":"Josefin Sans","18":1}'
                    >Thịt bò Angus, Hereford, Wagyu, Brahman và
                    Droughtmaster&nbsp;</span
                  >
                </div>
              </div>
          ...
          <div class="menu-col col-lg-6 col-md-12 col-sm-12">
            <div class="dish-block">
              <div class="inner-box">
                ...
                <div class="text desc">Thịt bò Angus, Hereford, Wagyu</div>
              </div>
            </div>
          </div>
          <div class="menu-col col-lg-6 col-md-12 col-sm-12">
          ...
          <div class="menu-col col-lg-6 col-md-12 col-sm-12">
            <div class="dish-block">
              <div class="inner-box">
                ...
                <div class="text desc">
                  <span>Thịt heo đông lạnh Đức cao cấp </span
                  ><span>Deutsche Schweinefleisch </span><span> </span>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="inner-box">
                ...
                <div class="text desc">
                  <span
                    ...
                    data-sheets-userformat='{"2":6723,"3":{"1":0},"4":{"1":2,"2":16777215},"9":0,"12":0,"14":{"1":2,"2":0},"15":"Josefin Sans"}'
                    >Bào ngư được vận chuyển tươi sống đến các nhà máy sản xuất
                    và chế biến. Sau đó, xưởng sẽ dùng công nghệ tiên tiến và
                    khép kín để chế biến đảm bảo giữ hương vị tươi ngon và được
                    đóng thành lon để tiện sử dụng.&nbsp;</span
                  >
                </div>
              </div>
            </div>
            ...
            <div class="dish-block">
              <div class="inner-box">
                ...
                <div class="title clearfix">
                  ...
                  <div class="price"><span>NEW</span></div>
                </div>
                <div class="text desc"></div>
              </div>
            </div>
              ...
              <div class="inner-box">
                ...
                <div class="text desc">
                  <span
                    ...
                    data-sheets-userformat='{"2":4609,"3":{"1":0},"12":0,"15":"Josefin Sans"}'
                    >Úc là một trong những nhà sản xuất rượu vang hàng đầu thế
                    giới, và nổi tiếng với các loại rượu vang cao cấp như
                    Shiraz, Cabernet Sauvignon và Chardonnay.</span
                  >
                </div>
              </div>
            </div>
          ...
          <div class="menu-col col-lg-6 col-md-12 col-sm-12">
            <div class="dish-block">
              <div class="inner-box">
                ...
                <div class="text desc">
                  Sản phẩm bao gồm các loại whisky, rượu mạnh, rượu brandy và
                  rượu rum.&nbsp;
                </div>
              </div>
            </div>
          ...
          <div class="menu-col col-lg-6 col-md-12 col-sm-12">
            <div class="dish-block">
              <div class="inner-box">
                ...
                <div class="text desc">Nhập khẩu trực tiếp từ nông trại Úc</div>
              </div>
            </div>
          </div>
          <div class="menu-col col-lg-6 col-md-12 col-sm-12">
              ...
              <div class="inner-box">
                ...
                <div class="text desc">
                  <span
                    data-sheets-value='{"1":2,"2":"Rượu vang: Úc là một trong những nhà sản xuất rượu vang hàng đầu thế giới, và nổi tiếng với các loại rượu vang cao cấp như Shiraz, Cabernet Sauvignon và Chardonnay."}'
                    data-sheets-userformat='{"2":4609,"3":{"1":0},"12":0,"15":"Josefin Sans"}'
                    >Hạt chia (The Chia Co, Morlife, Changing Habits), Hạt lanh
                    (Linwoods, Brookfarm, Power Super Foods), Hạt bí (Blue
                    Dinosaur, East Bali Cashews, The Protein Bread Co),v.v.<br /><br
                  /></span>
                </div>
              </div>
            </div>
      ...
      <div class="auto-container">
        <div class="title-box centered">
          <div class="pattern-image">
            <h2>TƯ VẤN GIẤY PHÉP XUẤT NHẬP KHẨU QUỐC TẾ</h2>
          </div>
        </div>
        <ul>
          <li class="text desc" style="text-align: center">
            ...
            nhập khẩu. Đồng thời, chúng tôi cũng hỗ trợ các dịch vụ khác liên
            quan kinh doanh và vận hành doanh nghiệp xuất nhập khẩu (tìm nhà
            cung cấp, nhà phân phối, tính thuế xuất nhập khẩu, áp mã hàng hóa,
            các chính sách liên quan đến thuế như hoàn thuế nhập khẩu… và đặc
            biệt là các hình thức thanh toán quốc tế khác nhau).
          </li>
        </ul>
        <br /><img
          src="@/assets/ig/Whcpewi.jpeg"
          class="img-fluid"
          alt=""
                  ...
                  >
                    <div class="s-block">
                      <div class="inner">
                        ...
                        <div class="text">
                          Fribin là một nhà cung cấp thịt tươi sống uy tín đến
                          từ Tây Ban Nha. Fribin sở hữu và quản lý mạng lưới các
                          nông trại và đối tác chăn nuôi trong nước hoặc khu vực
                          lân cận. Fribin có thể cam kết đảm bảo chất lượng của
                          sản phẩm thông qua việc tuân thủ các tiêu chuẩn an
                          toàn thực phẩm, quy trình kiểm soát chất lượng và quản
                          lý chuỗi cung ứng.<br /><br /><br />
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    <div class="s-block alternate">
                      <div class="inner">
                        ...
                        <div class="text">
                          <span
                            >Tönnies được thành lập vào năm 1971 bởi Clemens
                    ...
                    <div class="s-block">
                      <div class="inner">
                        ...
                        <div class="text">
                          ...
                          những tập đoàn thực phẩm lớn nhất thế giới. Suốt hơn
                          85 năm, Công ty đã mở rộng và có mặt trong hơn 100
                          quốc gia và vùng lãnh thổ, đồng thời xuất khẩu sản
                          phẩm thịt đến nhiều thị trường quốc tế. Tyson Foods
                          cam kết đảm bảo chất lượng và an toàn thực phẩm và
                          cũng đặt mục tiêu thực hiện hoạt động kinh doanh một
                          cách bền vững và có trách nhiệm xã hội. Công ty hướng
                          tới giảm thiểu tác động môi trường, nâng cao khâu chăm
                          sóc động vật và hỗ trợ cộng đồng trong các hoạt động
                          xã hội.
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="s-block">
                      <div class="inner">
                        ...
                        <div class="text">
                          ...
                          được sự tin cậy từ khách hàng và đối tác trong ngành
                          với các chứng nhận như ISO 22000 và HACCP, v.v<br /><br /><br />
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    <div class="s-block alternate">
                      <div class="inner">
                        ...
                        <div class="text">
                          Bên cạnh sở hữu và quản lý các trang trại hàu hiện
                          đại, Yumbah còn nổi tiếng với sản phẩm bào ngư viền
                          xanh - &nbsp;sản phẩm bào ngư ngon nhất Thế giới. Sự
                          uy tín của Yumbah thể hiện qua sự cẩn thận và kỹ lưỡng
                          trong phương pháp nuôi trồng. Yumbah là đối tác đáng
                          tin cậy với hàng loạt chứng nhận: Export Registered
                          (Chứng nhận xuất xứ), HACCP, SQF, ATT (Doanh nghiệp uy
                          tín tại Úc), Known Consignor (Nhà bán hàng được xác
                          nhận), ASC Certified Farms (Nông trại đạt chuẩn ASC),
                          v.v
                        </div>
                      </div>
                    </div>
            ...
            <div class="inner-box wow fadeInUp">
              <div class="image-box">
                ...
                <div class="over-content">
                  <div class="cat"></div>
                  <h4>
                    Vì sao bào ngư viền xanh Úc đắt đỏ và được giới thượng lưu
                    săn lùng
                  </h4>
                </div>
              </div>
            ...
            <div class="inner-box wow fadeInUp">
              <div class="image-box">
                ...
                <div class="over-content">
                  <div class="cat"></div>
                  <h4>
                    Bào ngư Úc: Phân loại, cách chọn và hướng dẫn chế biến
                  </h4>
                </div>
              </div>
            </div>
    ...
    <div data-include="footer">
      <footer class="main-footer">
        <div
          class="image-layer"
          :style="{
            background: `url(${require('@/assets/ig/WqRof9g.jpeg')}) center/cover no-repeat`,
          }"
        ></div>
        <div class="upper-section">
          <div class="auto-container">
            <div class="row clearfix">
                  ...
                  <div class="content">
                    <div class="logo">
                      <span style="color: #ffffff"
                        ><a href="#" title="TSI" style="color: #ffffff"
                          ><img
                            src="https://tsi.com.vn/assets/images/logo.png"
                            alt=""
                            title="TSI" /></a
                    ...
                    <div class="info">
                      <ul>
                        <li>
                          <span style="color: #ffffff">
                            Số nhà 20 ngõ 58/3 đường Trần Bình, Quận Cầu Giấy,
                            Hà Nội.;
                          </span>
                        </li>
                        <li>
                          <span style="color: #ffffff"
                            >Tầng 18, Tòa nhà The METT , 15 Trần Bạch Đằng
                            Phường An Khánh, TP. Hồ Chí Minh</span
                          >
                        </li>
                        <li>
                          <span style="color: #ffffff"
                            ><a href="#" style="color: #ffffff"
                              >Paul.nguyen@tsi.com.vn</a
                            ></span
                          >
                        </li>
                        <li>
                          <span style="color: #ffffff"
                            ><a href="#" style="color: #ffffff"
                              >Thông tin liên hệ: (+84) 856 936 666</a
                            ></span
                          >
                        </li>
                      </ul>
              ...
              <div class="footer-col links-col col-lg-3 col-md-6 col-sm-12">
                <div class="inner wow fadeInLeft">
                  <ul class="links">
                    <li>
                      <span style="color: #ffffff"
                        ><a href="#" style="color: #ffffff">Chính sách</a></span
                      >
                    </li>
                  </ul>
                </div>
              ...
              <div
                class="footer-col links-col last col-lg-3 col-md-6 col-sm-12"
              >
                <div class="inner wow fadeInRight">
                  <ul class="links">
                    <li>
                      <span style="color: #ffffff"
                        ><a href="#" style="color: #ffffff">Giới thiệu</a></span
                      >
                    </li>
                    <li>
                      <span style="color: #ffffff"
                        ><a href="#" style="color: #ffffff">Liên hệ</a></span
                      >
                    </li>
                  </ul>
                </div>
...
.info-bar {
  ...
  opacity: 0;
  background: var(--color-two)
    url(https://kalanidhithemes.com/live-preview/landing-page/delici/all-demo/Delici-Different-Design-With-Center-Header/images/background/pattern-7.png)
    center top repeat;
  visibility: hidden;
...
.offer-block .inner-box .image:before {
  ...
  -o-transition: all 500ms ease;
  transition: all 500ms ease;
  background: url(https://kalanidhithemes.com/live-preview/landing-page/delici/all-demo/Delici-Different-Design-With-Center-Header/images/background/pattern-8.svg)
    center repeat;
}
...
.story-section .image-col .round-stamp:before {
  ...
  right: 0px;
  bottom: 0px;
  background: url(https://kalanidhithemes.com/live-preview/landing-page/delici/all-demo/Delici-Different-Design-With-Center-Header/images/resource/badge-1-bg.png)
    no-repeat;
}
...
.reserve-section .info-col {
  ...
  padding: 0 0;
  text-align: center;
  background: url(https://kalanidhithemes.com/live-preview/landing-page/delici/all-demo/Delici-Different-Design-With-Center-Header/images/background/pattern-2.png)
    left top repeat;
}
...
.intro-section .fact-counter:before {
  ...
  width: 100%;
  height: 18px;
  background: url(https://kalanidhithemes.com/live-preview/landing-page/delici/all-demo/Delici-Different-Design-With-Center-Header/images/background/pattern-10.svg)
    left top repeat;
}
...
.menu-one .image-col .image:before {
  ...
  width: 15px;
  height: 100%;
  /*background: url(https://kalanidhithemes.com/live-preview/landing-page/delici/all-demo/Delici-Different-Design-With-Center-Header/images/background/pattern-9.svg) center top repeat;*/
}
...
.featured-section .text-col .inner {
  ...
  padding-left: var(--padding-left-25);
  padding-right: var(--padding-right-25);
  background: url(https://kalanidhithemes.com/live-preview/landing-page/delici/all-demo/Delici-Different-Design-With-Center-Header/images/background/pattern-5.png)
    left top repeat;
  background-color: var(--color-five);
  padding-top: var(--padding-top-30);
  padding-bottom: var(--padding-bottom-50);

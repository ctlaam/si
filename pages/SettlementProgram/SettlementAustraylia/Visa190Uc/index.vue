                                ...
                                <div class="slick-list draggable">
                                    <div class="slick-track"
                                        ...
                                        <div class="slick-slide slick-cloned" data-slick-index="-1" id=""
                                            ...
                                            <div data-bg="https://sigroup.vn/wp-content/uploads/2023/11/23_c62fdf128d.jpg"
                                                style="background-image: url(&quot;https://sigroup.vn/wp-content/uploads/2023/11/23_c62fdf128d.jpg&quot;);"
                                        ...
                                        <div class="slick-slide" data-slick-index="0" aria-hidden="true" tabindex="-1"
                                            ...
                                            style="width: 936px;">
                                            <div data-bg="https://sigroup.vn/wp-content/uploads/2023/11/22_de32556ff1.jpg"
                                                style="background-image: url(&quot;https://sigroup.vn/wp-content/uploads/2023/11/22_de32556ff1.jpg&quot;);"
                                                class="position-relative justify-center align-items-center bg-banner vh-80 rocket-lazyload entered lazyloaded"
                                                data-ll-status="loaded">
=                                                <div class="position-relative w-100 h-100 banner-wrap">
                                                    <div class="mb-10 w-100">
                                        ...
                                        <div class="slick-slide" data-slick-index="1" aria-hidden="true" tabindex="-1"
                                            ...
                                            style="width: 936px;">
                                            <div data-bg="https://sigroup.vn/wp-content/uploads/2023/11/24_52144d5344.jpg"
                                                style="background-image: url(&quot;https://sigroup.vn/wp-content/uploads/2023/11/24_52144d5344.jpg&quot;);"
                                                class="position-relative justify-center align-items-center bg-banner vh-80 rocket-lazyload entered lazyloaded"
                                                data-ll-status="loaded">
                            ...
                            <div class="my-5">
                                <h1 class="si-title">Visa 190 Úc – Định cư Úc diện tay nghề bảo lãnh bang</h1>
                            </div>
                            <div class="py-3 excerpt">Visa 190 là visa tay nghề thường trú Úc cho phép người lao động
                                nước ngoài đến Úc sinh sống và làm việc với điều kiện được tiểu bang hoặc vùng lãnh thổ
                                đề cử (hoặc bảo lãnh).</div>
                        </div>
                        <div class="advantage pa-5">
                            <h1 class="text-center si-title">ƯU ĐIỂM VISA 190</h1>
                            <div class="mt-5 row">
                                ...
                                <div class="col-12 col-md-6">
                                    <details class="condition">
                                        <summary class="d-flex flex-wrap align-items-stretch">
                                            ...
                                            <div class="title">Có thể bảo lãnh người thân khác định cư Úc</div>
                                        </summary>
                                        <div class="d-block text"></div>
                                    </details>
                                </div>
                                <div class="col-12 col-md-6">
                                    <details class="condition">
                                        <summary class="d-flex flex-wrap align-items-stretch">
                                            ...
                                            <div class="title">Thời gian xử lý hồ sơ nhanh chóng</div>
                                        </summary>
                                        <div class="d-block text"></div>
                                    </details>
                                </div>
                        ...
                        <div class="mt-5 benefit pa-5">
                            <h2 class="text-center si-title">QUYỀN LỢI VISA 190</h2>
                            <div class="d-flex flex-wrap wrap-be">
                                ...
                                <div class="d-flex align-items-center text-center si-benefit">
                                    <div>
                                        ...
                                        <p>Tự do sinh sống, học tập và làm việc tại Úc vô thời hạn </p>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center text-center si-benefit">
                                    <div>
                                        ...
                                        <p>Tham gia bảo hiểm y tế Medicare và chính sách phúc lợi xã hội khác </p>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center text-center si-benefit">
                                    <div>
                    ...
                    <div class="mt-10 col-12">
                        <h2 class="text-center si-title">ĐIỀU KIỆN VISA 190 </h2>
                        <div class="pt-5 rule">
                            <details class="condition">
                                ...
                                <div class="px-4 text">
                                    <ul>
                                        <li>Dưới 45 tuổi</li>
                                        <li>Có yêu cầu về sức khỏe và lý lịch tư pháp</li>
                                    </ul>
                                </div>
                            </details>
                            <details class="condition">
                                <summary class="d-flex flex-wrap align-items-stretch click">
                                    <div class="title">Điểm di trú</div>
                                    <div class="d-flex align-items-center justify-content-center icon">
                                        <span class="ic-down"></span>
                                    </div>
                                </summary>
                                <div class="px-4 text">
                                    <p>Tối thiểu 65 điểm</p>
                                </div>
                            </details>
                            <details class="condition">
                                <summary class="d-flex flex-wrap align-items-stretch click">
                            ...
                            <details class="condition">
                                ...
                                <div class="px-4 text">
                                    <p>Ứng viên có kinh nghiệm làm việc trong lĩnh vực nằm trong danh sách ưu
                                        tiên của tiểu bang hoặc vùng lãnh thổ&nbsp;</p>
                                </div>
                            </details>
                            <details class="condition">
                                <summary class="d-flex flex-wrap align-items-stretch click">
                                    <div class="title">Được tiểu bang hoặc vùng lãnh thổ bảo lãnh (đề cử) </div>
                                    <div class="d-flex align-items-center justify-content-center icon">
                                        <span class="ic-down"></span>
                                    </div>
                                </summary>
                                <div class="px-4 text">
                                    <p>Thể hiện thông qua việc nhận Thư mời nộp đơn</p>
                                </div>
                            </details>
                            <details class="condition">
                                <summary class="d-flex flex-wrap align-items-stretch click">
                                    <div class="title">Sở hữu Visa 491 hoặc Visa 494 </div>
                                    <div class="d-flex align-items-center justify-content-center icon">
                                        <span class="ic-down"></span>
                                    </div>
                                </summary>
                                <div class="px-4 text">
                                    <p>Thời gian sở hữu tối thiểu 3 năm trước thời điểm nộp đơn xin Visa 190</p>
                                </div>
                            </details>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <h2 class="text-center si-title">QUY TRÌNH CẤP VISA 190</h2>
                        <div class="d-flex flex-wrap application-process">
                            <div class="it">
                                <span>Đánh giá hồ sơ &amp; Ký Hợp đồng</span>
                            </div>
                            <div class="it">
                                <span>Sát hạch tay nghề (Skill Asssessment)</span>
                            </div>
                            <div class="it">
                                <span>Nộp thư bày tỏ nguyện vọng (EOI)</span>
                            </div>
                            <div class="it">
                                <span>Nộp đơn xin bảo lãnh bang</span>
                            </div>
                            <div class="it">
                                <span>Nhận ITA và nộp hồ sơ xin thị thực</span>
                            </div>
                            <div class="it">
                                <span>Nhận visa 190 &amp; Sang Úc</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
                    ...
                    <div class="col-12">
                        <div class="content">
                            ...
                            <h2><strong>Visa 190 là gì?</strong></h2>
                            <p><span style="font-weight: 400;">Visa 190 là visa thường trú Úc dành cho người lao động
                                    nước ngoài đến Úc sinh sống và làm việc với điều kiện được tiểu bang hoặc vùng lãnh
                                    thổ đề cử.&nbsp;&nbsp;</span></p>
                            <h2><strong>Bí quyết tăng điểm di trú xin Visa 190 Úc</strong></h2>
                            <p><span style="font-weight: 400;">Nếu điểm di trú Úc dưới 65 điểm hoặc quý vị muốn tăng
                                    điểm di trú để có thêm cơ hội nhận Visa 190 Úc thì dưới đây là các mẹo hữu
                                    ích:</span></p>
                            <ul>
                                <li style="font-weight: 400;" aria-level="1"><span style="font-weight: 400;">Cải thiện
                                        trình độ tiếng Anh: Điểm IELTS 7.0 hoặc PTE 65 có thể giúp quý vị được cộng thêm
                                        10 hoặc 20 điểm;</span></li>
                                <li style="font-weight: 400;" aria-level="1"><span style="font-weight: 400;">Thực hiện
                                        bài kiểm tra ngôn ngữ khác (ngoài tiếng Anh) được cộng đồng công nhận và đạt yêu
                                        cầu: Được cộng thêm 5 điểm;</span></li>
                                <li style="font-weight: 400;" aria-level="1"><span style="font-weight: 400;">Tích lũy
                                        kinh nghiệm làm việc tại Úc hoặc tại nước ngoài: Được cộng từ 5 đến 20 điểm tùy
                                        vào năm kinh nghiệm làm việc và nơi làm việc;</span></li>
                                <li style="font-weight: 400;" aria-level="1"><span style="font-weight: 400;">Trình độ
                                        chuyên môn cao được thể hiện thông qua bằng cấp cao: Được cộng từ 5 đến 10 điểm
                                        tùy vào chương trình học và cấp độ bằng cấp;</span></li>
                                <li style="font-weight: 400;" aria-level="1"><span style="font-weight: 400;">Đề cử hoặc
                                        bảo lãnh của tiểu bang hoặc vùng lãnh thổ: Được cộng 5 điểm;</span></li>
                                <li style="font-weight: 400;" aria-level="1"><span style="font-weight: 400;">Vợ/chồng đi
                                        cùng hồ sơ dưới 45 tuổi, có kỹ năng tay nghề và trình độ tiếng Anh: Được cộng
                                        tối đa 10 điểm.&nbsp;</span></li>
                            </ul>
                            <h2><strong>Chi phí xin Visa 190 Úc</strong></h2>
                            <p><span style="font-weight: 400;">Phí nộp đơn xin cấp Visa 190 Úc gồm:</span></p>
                            <ul>
                                <li style="font-weight: 400;" aria-level="1"><span style="font-weight: 400;">Đối với
                                        đương đơn chính: 4,770 AUD;</span></li>
                                <li style="font-weight: 400;" aria-level="1"><span style="font-weight: 400;">Đối với
                                        người từ đủ 18 tuổi trở lên đi kèm hồ sơ: 2,385 AUD;</span></li>
                                <li style="font-weight: 400;" aria-level="1"><span style="font-weight: 400;">Đối với
                                        người dưới 18 tuổi đi cùng hồ sơ: 1,190 AUD.</span></li>
                            </ul>
